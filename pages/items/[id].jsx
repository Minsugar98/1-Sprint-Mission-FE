...
function Market({ id }) {
  const { values, handleChange, handleSubmit, resetForm, isSubmitting } = (0,
  form_1.default)({
    name: '',
    description: '',
    price: '',
  ...
  const [isProductModalOpen, setIsProductModalOpen] = (0, react_1.useState)(
    false
  );
  const [checkModal, setCheckModal] = (0, react_1.useState)(false);
  const [isCommentsModalOpen, setIsCommentsModalOpen] = (0, react_1.useState)(
    false
  );
  const [commentId, setCommentId] = (0, react_1.useState)();
  const [isProductDeleteModalOpen, setIsProductDeleteModalOpen] = (0,
              ...
              (_b =
                (_a =
                  response === null || response === void 0
                    ? void 0
                    : response.response) === null || _a === void 0
                  ? void 0
      ...
      try {
        ...
        if (isAxiosResponse(res)) {
          ...
          console.error(
            '댓글 수정 중 오류 발생:',
            (_b =
              (_a = res === null || res === void 0 ? void 0 : res.response) ===
                null || _a === void 0
                ? void 0
                : _a.data) === null || _b === void 0
              ? void 0
    ...
    <>
      ...
      <div className={id_module_css_1.default.marketContainer}>
          ...
          <div className={id_module_css_1.default.marketProductTitle}>
            <div className={id_module_css_1.default.marketTitle}>
              ...
              <image_1.default
                ...
                width={24}
                height={24}
                className={id_module_css_1.default.menuBtn}
                alt="menu"
              />
              {isOpen && (
                <ul className={id_module_css_1.default.menu}>
                  <li
            ...
            <div className={id_module_css_1.default.marketContentName}>
              상품 소개
            </div>
            <div className={id_module_css_1.default.marketContent}>
              {product === null || product === void 0
                ? void 0
                : product.description}
            </div>
            <div className={id_module_css_1.default.marketTagName}>
              상품태그
            </div>
            <div className={id_module_css_1.default.marketTag}>
              {(product === null || product === void 0
                ...
                product.tags.map((tag, index) => (
                  <p className={id_module_css_1.default.tag} key={index}>
                    #{tag}
                  </p>
                ))
              ) : (
            ...
            <div className={id_module_css_1.default.marketProfile}>
              ...
              <button
                className={id_module_css_1.default.favorite}
                onClick={() =>
                  __awaiter(this, void 0, void 0, function* () {
                    yield (0,
                    products_1.postfavorite)((product === null || product === void 0 ? void 0 : product.id) || '');
                  })
                }
              >
                {'♡' +
        ...
        <div className={id_module_css_1.default.marketArticle}>
          ...
          <textarea
            className={id_module_css_1.default.marketArticleTextarea}
            placeholder="개인정보를 공유 및 요청하거나, 명예 훼손, 무단 광고, 불법 정보 유포시 모니터링 후 삭제될 수 있으며, 이에 대한 민협사상 책임을 게시자에게 있습니다."
            onChange={handleContentChange}
          ></textarea>
          <button
            className={id_module_css_1.default.marketArticleBtn}
            onClick={() =>
              __awaiter(this, void 0, void 0, function* () {
                yield (0,
                comments_1.postComment)((product === null || product === void 0 ? void 0 : product.id) || '', { content: commentData });
              })
            }
          >
            등록
          ...
          <div>
            {comments.map((comment, index) => (
              <div
                key={index}
                className={id_module_css_1.default.marketArticleContainer}
              >
                <div className={id_module_css_1.default.marketArticleContent}>
                  <p
                    className={
                      id_module_css_1.default.marketArticleContentTitle
                    }
                  >
                    {comment.content}
                  </p>{' '}
                  <image_1.default
                    ...
                    width={24}
                    height={24}
                    className={id_module_css_1.default.commentMenu}
                    alt="menu"
                  />
                  {openComments[index] && (
                    <ul className={id_module_css_1.default.menu}>
                ...
                <div
                  className={
                    id_module_css_1.default.marketArticleProfileContainer
                  }
                >
                  <div>
                    <image_1.default
                  ...
                  <div
                    className={id_module_css_1.default.marketArticleProfileInfo}
                  >
                    <p
                      className={
                        id_module_css_1.default.marketArticleProfileName
                      }
                    >
                      {comment.nickname}
                    </p>{' '}
                    <p
                      className={
                        id_module_css_1.default.marketArticleProfileDate
                      }
                    >
          ...
          <div className={id_module_css_1.default.marketArticleFooter}>
            <button
              className={id_module_css_1.default.marketArticleFooterBtn}
