        ...
        const fetchProduct = () => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (isAxiosResponse(response)) {
                    ...
                    console.error('제품 정보를 가져오는 중 오류 발생:', (_b = (_a = response === null || response === void 0 ? void 0 : response.response) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.message);
                }
            }
            catch (error) {
        ...
        const fetchComments = () => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (isAxiosResponse(response)) {
                    ...
                    console.error('댓글을 가져오는 중 오류 발생:', (_b = (_a = response === null || response === void 0 ? void 0 : response.response) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.message);
                }
            }
            catch (error) {
    ...
    return (<>
      ...
      <div className={id_module_css_1.default.marketContainer}>
        ...
        <div className={id_module_css_1.default.marketArticle}>
          ...
          <div>
            {comments.map((comment, index) => (<div key={index} className={id_module_css_1.default.marketArticleContainer}>
